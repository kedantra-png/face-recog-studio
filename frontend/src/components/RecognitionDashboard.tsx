        ...
        <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-5 shadow-lg flex flex-col justify-between">
          ...
          <div className="my-2">
            <span className="text-2xl font-bold text-purple-400">
              {anti_spoof_confidence ? Math.round(anti_spoof_confidence * 100) : 95}%
            </span>
            <span className="text-xs text-emerald-400 ml-1.5">REAL</span>
          </div>
          <div className="w-full bg-slate-800 h-2 rounded-full overflow-hidden">
            <div
              className="h-full bg-purple-400 transition-all duration-500"
              style={{ width: `${anti_spoof_confidence ? Math.round(anti_spoof_confidence * 100) : 95}%` }}
            />
          </div>
        </div>
